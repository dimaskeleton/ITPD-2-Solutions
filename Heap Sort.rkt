...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname |Heap Sort|) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp")) #f)))
...
(define (heap-sort! V)
  (local [; parent: natnum -> natnum
          ...
          (define (heapify! low high)
            (cond [(empty-VINT? low high) (void)] ; There is nothing to heapify
                  [else
          ...
          (define (sort! low high)
            (cond [(empty-VINT? low high) (void)] ; there is nothing to sort
                  [else (begin
